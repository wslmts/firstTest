var BJ_REPORT = (function (E) {
    ...
    var M = [];
    var J = {id: 0, uin: 0, url: "", combo: 1, ext: {}, level: 4, ignore: [], random: 1, delay: 1000, submit: null};
    var O = function (R, Q) {
    ...
    E.onerror = function (V, U, Q, T, S) {
        ...
        G.push({msg: R, target: U, rowNum: Q, colNum: T});
        B();
    ...
    var K = function (S) {
        try {
            if (S.stack) {
                ...
                var Q = H(S);
                return {msg: Q, rowNum: U[1], colNum: U[2], target: R.replace(U[0], "")}
            } else {
                return S
            }
        } catch (T) {
    ...
    var B = function (U) {
        ...
        while (M.length) {
            ...
            var Q = N(W, L.length);
            if (O(J.ignore, "Array")) {
                for (var T = 0, S = J.ignore.length; T < S; T++) {
                    var X = J.ignore[T];
...
;
(function () {
    BJ_REPORT.init({id: 1056, combo: 1, delay: 100, random: 0.1, level: 4});
})();
!function () {
    function n(n, t, o) {
        o = o || window;
        var r = o[n];
        r && r.apply && t && t.apply && (o[n] = function () {
    ...
    function r() {
        ...
        if (window.console)for (var a = 0; a < e.length; a++) {
            var i = e[a];
            n(i, function () {
                t(0)
            }, window.console)
